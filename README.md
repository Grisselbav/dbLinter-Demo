...
The [database installation step](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L62-L64) produced this [install.log](https://grisselbav.github.io/dbLinter-Demo/install.log) file.

### Check

Raw formats produced by the [CLI](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L85-L101):
...
| ------ | -------- | ----- |
| [Summary Check Report](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/20003024651#user-content-dblinter-check-report) | [Custom Script](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L209-L214) | The content of check.vscode.md in the summary page of a run. See also the standalone [HTML](https://grisselbav.github.io/dbLinter-Demo/check-report.html) file. |
| [Annotations](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/20003024651#user-content-core-g-9219) | [Custom Script](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L114-L116) | The result when printing the content of check.github.txt to sysout. |
| [Code Scanning Alerts](https://github.com/Grisselbav/dbLinter-Demo/security/code-scanning/719) | [github/codeql-action/upload-sarif](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L109-L112) | This action produces code scanning alerts. The alerts are part of the Security tab, which cannot be made visible to the public. See also [About code scanning alerts](https://docs.github.com/en/code-security/code-scanning/managing-code-scanning-alerts/about-code-scanning-alerts) |
...
Raw formats produced by the [CLI](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L118-L134):
...
| Result | Producer | Notes |
| ------ | -------- | ----- |
| [Summary Test Report](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/20003024651#user-content-dblinter-test-report) | [Custom Script](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L216-L221) | The content of test.vscode.md in the summary page of a run. See also the standalone [HTML](https://grisselbav.github.io/dbLinter-Demo/test-report.html) file. |
| [Test Results (EnricoMi)](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/20003024651/job/57361186473) | [EnricoMi/publish-unit-test-result-action](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L191-L198) | This action produces a own check (job) result. All details of a failure are accessible via a `Raw output` button. |
| [Test Results (dorny)](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/20003024651#summary-57361127378) | [dorny/test-reporter](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L200-L207) | This action adds a section in the Summary report of the workflow. |
