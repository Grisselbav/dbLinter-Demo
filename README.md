...
The [CI workflow](.github/workflows/ci.yml) uses the [dbLinter CLI](https://grisselbav.github.io/dbLinter/reference/architecture/#cli) to check all SQL files in this repository and the database objets in the Oracle AI Database for compliance
