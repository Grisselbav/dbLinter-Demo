...
| ------ | -------- | ----- |
| [Summary Check Report](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/22548097638#user-content-dblinter-check-report) | [Custom Script](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L217-L222) | The content of check.vscode.md in the summary page of a run. See also the standalone [HTML](https://grisselbav.github.io/dbLinter-Demo/check-report.html) file. |
| [Annotations](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/22548097638#user-content-core-g-9219) | [Custom Script](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L122-L124) | The result when printing the content of check.github.txt to stdout. |
| [Code Scanning Alerts](https://github.com/Grisselbav/dbLinter-Demo/security/code-scanning/719) | [github/codeql-action/upload-sarif](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L117-L120) | This action produces code scanning alerts. The alerts are part of the Security tab, which cannot be made visible to the public. See also [About code scanning alerts](https://docs.github.com/en/code-security/code-scanning/managing-code-scanning-alerts/about-code-scanning-alerts) |
| [SonarQube Cloud Issues](https://sonarcloud.io/project/issues?rules=external_dbLinter%3ACore+G-9501&issueStatuses=OPEN%2CCONFIRMED&id=dbLinter-Demo) | [SonarSource/sonarqube-scan-action](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L105-L109) | This action scans the source and populates the result on SonarQube Cloud along the results in [check.sonarqube.json](https://grisselbav.github.io/dbLinter-Demo/check.sonarqube.json). See [Official SonarQube Scan](https://github.com/marketplace/actions/official-sonarqube-scan). |
...
| Result | Producer | Notes |
| ------ | -------- | ----- |
| [Summary Test Report](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/22548097638#user-content-dblinter-test-report) | [Custom Script](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L224-L229) | The content of test.vscode.md in the summary page of a run. See also the standalone [HTML](https://grisselbav.github.io/dbLinter-Demo/test-report.html) file. |
| [Test Results (EnricoMi)](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/22548097638/job/65313642861) | [EnricoMi/publish-unit-test-result-action](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L199-L206) | This action produces a own check (job) result. All details of a failure are accessible via a `Raw output` button. |
| [Test Results (dorny)](https://github.com/Grisselbav/dbLinter-Demo/actions/runs/22548097638#summary-65313642861) | [dorny/test-reporter](https://github.com/Grisselbav/dbLinter-Demo/blob/main/.github/workflows/ci.yml#L208-L215) | This action adds a section in the Summary report of the workflow. |
